...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li ><a href="/contact/emails"><i class="gfa fa-angle-right"></i>Emails</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/projets"><i class="gfa fa-angle-right"></i> Nos Projets</a></li>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Modifier Réseau</li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ModifierReseau/{{$reseau->id}}" >
  ...
  <option <?php if ($reseau->type=='Facebook') { ?> selected <?php } ?> >Facebook</option>
  <option  <?php if ($reseau->type=='Instagram') { ?> selected <?php } ?>>Instagram</option>
  <option  <?php if ($reseau->type=='Linkedin') { ?> selected <?php } ?>>Linkedin</option>
  <option  <?php if ($reseau->type=='Twitter') { ?> selected <?php } ?>>Twitter</option>
  <option  <?php if ($reseau->type=='Google Plus') { ?> selected <?php } ?>>Google Plus</option>
<option  <?php if ($reseau->type=='Tumblr') { ?> selected <?php } ?>>Tumblr</option>
<option  <?php if ($reseau->type=='Youtube') { ?> selected <?php } ?>>Youtube</option> 
 ...
 @if ($errors->has('type'))
    ...
    <input type="url" placeholder="Url.." class="form-control "  id="url" name="url"  value="{{ $reseau->url }}"  placeholder="https://example.com"
