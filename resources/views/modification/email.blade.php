   ...
   <aside class="main-sidebar">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/contact/emails">Emails</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ModifierEmail/{{$email->id}}" >
       ...
       <div class="input-group {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <input type="email" class="form-control" placeholder="Email" value="{{ $email->email }}" id="email" name="email" required autofocus>
