        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
                <form method="post" action="/offre/modifier/{{$offre->id}}" >
         
        {{ csrf_field() }} 
         
 
  
                     <input hidden="hidden" value="{{$projet->nom}}" name="projet" >  
  ...
  <div class="form-group">
   ...
   <select class="form-control select2" id=type_offre"  name="type_offre" data-placeholder="Selectoinner  Type d'offre" style="width: 100%;">
    ...
    @foreach($offres as $offre1)
     <option <?php if (($offre->type==$offre1->nom)) {?> selected <?php } ?>>{{$offre1->nom}}</option>
                  ...
                  @endforeach
						 ...
						 <input type="date" class="form-control pull-right"   name="date_debut" id="date_debut" value="{{$offre->date_debut}}" required>                 </div>
						...
						<input type="date" class="form-control pull-right"   name="date_fin" id="date_fin"  value="{{$offre->date_fin}}" required>              
						</div>    
