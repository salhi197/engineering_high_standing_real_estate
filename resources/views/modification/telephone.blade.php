...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/contact/telephones">Téléphone</a></li>
        <li class="active">Modifier Téléphone</li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ModifierTelephone/{{$telephone->id}}" >
  ...
  <div class="form-group {{ $errors->has('telephone') ? 'has-error' : '' }}">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" data-inputmask='"mask": "(9) 999 999 999"'  value="{{ $telephone->telephone }}"  id="telephone" name="telephone" data-mask>
                </div>
                <!-- /.input group -->
