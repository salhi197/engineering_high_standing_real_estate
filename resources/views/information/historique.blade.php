 ...
 <aside class="main-sidebar">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/contact/adresse">Historiques</a></li>
...
<strong >Action :</strong>  <br>
                           <p> {{ $historique->actoin}}</p>


<br>
     <strong >Sur La table :</strong>  <br>
                 <p>            {{ $historique->table}}</p>
 <br>
    <strong >Action effectué par :</strong>  <br>
         <p>            {{ $historique->user_name}}</p>
                            <br>
    <strong >Infromarions :</strong>  <br>
     <p>            {!! $historique->information !!}</p>
<br>
  <strong >Date :</strong>  <br>
     <p>          {{date('d/m/Y H:i', strtotime($historique->created_at))}}</p>
    </p>
