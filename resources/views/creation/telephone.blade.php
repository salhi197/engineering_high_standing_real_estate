...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nouveau Téléphone</li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ajouterTelephone" >
  ...
  <div class="form-group {{ $errors->has('telephone') ? 'has-error' : '' }}">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" data-inputmask='"mask": "(9) 999 999 999"' value="{{ old('telephone') }}"  id="telephone" name="telephone" data-mask>
                </div>
                <!-- /.input group -->
