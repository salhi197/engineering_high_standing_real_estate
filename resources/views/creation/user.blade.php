...
@section('content')
  <aside class="main-sidebar">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nouveau Utlisateur</li>
      </ol>
    </section>
          ...
          <div class="box box-info">
            ...
            {{ csrf_field() }}
              <div class="form-group{{ $errors->has('name') ? 'has-error' : '' }}">
                <label>Nom:</label>
                <input type="text"  class="form-control"  id="name" name="name" required autofocus placeholder="name" value="{{ old('name') }}" >
         @if ($errors->has('name'))
    ...
    <label for="email">{{ __('E-Mail Address') }}</label>
      ...
      <input type="email"  class="form-control"  id="email" name="email" required autofocus placeholder="Email" value="{{ old('email') }}">
         @if ($errors->has('email'))
                                    <span class="help-block">
  ...
  <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
    ...
    <option <?php if (old('type')== 'Administrateur'){  ?> selected <?php } ?>>Administrateur</option>
     <option <?php if (old('type')== 'Administrateur Site'){  ?> selected <?php } ?> >Administrateur Site</option>
