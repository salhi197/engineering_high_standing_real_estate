...
<aside class="main-sidebar">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nouveau Fax</li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ajouterFax" >
  ...
  <div class="form-group {{ $errors->has('fax') ? 'has-error' : '' }}">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" data-inputmask='"mask": "(9) 99 99 99 99"'  id="fax" name="fax"  value="{{ old('fax') }}" data-mask>
                </div>
                <!-- /.input group -->
                 @if ($errors->has('fax'))
