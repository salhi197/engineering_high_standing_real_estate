...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nouvelle Adresses</li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <form method="post" action="/ajouterAdresse" >
    ...
    <textarea id="adresse" placeholder="Votre Adresse..."  name="adresse" class="form-control " required >{{ old('adresse') }}</textarea>
