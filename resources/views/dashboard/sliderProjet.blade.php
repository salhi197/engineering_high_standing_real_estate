...
@section('content')
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/slider/projets"><i class="fa fa-angle-right"></i> Slider des Projets</a></li>
    ...
    <section class="content-header">
         ...
         <div class="row">
		 <div class="col-md-3">
          <a class="btn btn-primary" href="/SliderP/ajouter">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Slider Projets</li>
      </ol>
    </section>
                ...
                <thead>
                 <tr>
                  ...
                  <th>Supprimer</th>
                    ...
                    <tbody>
                  @foreach($SlidersP as $SliderP)
                <tr>
                   <td hidden="hidden">{{$SliderP->id}}</td>
                  <td>{{$SliderP->titre}}</td>
                   <td>{!! $SliderP->text !!}</td>
                 
                   <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/SlidersP/modifier/{{$SliderP->id}}"><i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p></td>
                        <td><p ><a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();" href="/SlidersP/supprimer/{{$SliderP->id}}"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
            <span class="nav-link-text"></span></a></p></td>
