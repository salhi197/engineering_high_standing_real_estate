 ...
 <aside class="main-sidebar">
    ...
    <section class="content-header">
           ...
           @if(isset($Standards->id))
			    <div class="row">
		 <div class="col-md-3">
           <a href="/standards/modifier/{{$Standards->id}}" class="btn btn-primary">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nos Standards</li>
      </ol>
    </section>
            ...
            <div class="box-body pad">
                  ...
                  @if(isset($Standards->id))
                    <div class="blog-details-wrap">
                        <p>
<strong id="securite">Sécurité</strong> : <br>
                            {!! $Standards->securite !!}
<br>
     <strong id="confort">Confort</strong> : <br>
                              {!! $Standards->confort !!}
 <br>
    <strong id="esthetique">Esthétique</strong> : <br>
         {!! $Standards->esthetique !!}
                            <br>
    <strong id="fonctoinnalite">Fonctionnalité</strong> : <br>
