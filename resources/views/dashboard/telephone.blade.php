...
@section('content')
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/contact/telephones"><i class="fa fa-angle-right"></i> Telephones</a></li>
    ...
    <section class="content-header">
      <div class="row">
		 <div class="col-md-3">
          <a class="btn btn-primary" href="/telephone/ajouter">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Nos Téléphones</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Table des Téléphones</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{'+213 '.$telephone->telephone}}</td>
                   <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/telephone/modifier/{{$telephone->id}}"><i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p></td>
                        <td><p >
                          <a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();" href="/telephone/supprimer/{{$telephone->id}}"class="btn btn-danger btn-xs">
 ...
 function sure()
{
    return(confirm('Etes-vous sûr de vouloir supprimer ce Téléphone ?'));
}
