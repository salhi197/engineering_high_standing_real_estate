...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/contact/emails"><i class="fa fa-angle-right"></i>Emails</a></li>
    ...
    <section class="content-header">
         ...
         <div class="row">
		 <div class="col-md-3">
          <a class="btn btn-primary" href="/email/ajouter">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Table des Emails</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <tbody>
                ...
                <tr>
                  <td hidden="hidden">{{$email->id}}</td>
                  <td>{{$email->email}}</td>
                   <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/email/modifier/{{$email->id}}"><i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p></td>
                        <td><p ><a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();" href="/email/supprimer/{{$email->id}}"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
            <span class="nav-link-text"></span></a></p></td>
