...
@section('content')
  <aside class="main-sidebar">
    ...
    <div class="row">
	<div class="col-md-3">
       <a class="btn btn-primary" href="/article/ajouter">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Table des Articles</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <th>Voir</th>
                  <th hidden="hidden">Auteurs</th>
                  <th hidden="hidden">motscles </th>
              ...
              <?php use Carbon\Carbon; Carbon::setLocale('fr');
                 ...
                 <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Voir"class="btn btn-default btn-xs" href="article/modifier/{{$article->id}}">
                           <i class="fa fa-search-plus"></i>
            <span class="nav-link-text"></span></a></p>
                       </td>
                  <td  hidden="hidden">@foreach($article->auteurs as $auteur) {{$auteur->nom}} @endforeach </td>
                   <td  hidden="hidden">@foreach($article->motcles as $motcle) {{$motcle->name}} @endforeach </td>
                 <td>{{Carbon::parse($article->created_at)->diffForHumans()}}</td>
                       <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer"class="btn btn-warning btn-xs" href="article/modifier/{{$article->id}}">
                           <i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p>
                       </td>
                        <td>
                            <p ><a data-placement="top" data-toggle="tooltip"   title="Supprimer" onclick="return sure();" href="article/supprimer/{{$article->id}}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
            <span class="nav-link-text"></span></a></p>
 ...
 function sure()
{
    return(confirm('Etes-vous sûr de vouloir supprimer cette Article ?'));
}
</script>
