...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/slider/articles"><i class="fa fa-angle-right"></i> Slider des Articles</a></li>
    ...
    <section class="content-header">
         ...
         <div class="row">
		 <div class="col-md-3">
          <a class="btn btn-primary" href="/SliderA/ajouter">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Slider Artcles</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Table des Sliders</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <thead>
                 <tr>
                  ...
                  <th>Supprimer</th>
                    ...
                    <tbody>
                  @foreach($SlidersA as $SliderA)
                <tr>
                   <td hidden="hidden">{{$SliderA->id}}</td>
                  <td>{{$SliderA->titre}}</td>
                   <td>{!! $SliderA->text !!}</td>
                  
                   <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/SlidersA/modifier/{{$SliderA->id}}"><i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p></td>
                        <td><p ><a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();" href="/SlidersA/supprimer/{{$SliderA->id}}"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
            <span class="nav-link-text"></span></a></p></td>
 ...
 function sure()
{
    return(confirm('Etes-vous sûr de vouloir supprimer ce Slider ?'));
}
</script>
