...
<aside class="main-sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/contact/faxs"><i class="fa fa-angle-right"></i>Faxs</a></li>
    ...
    <section class="content-header">
	 ...
	 <div  class="col-md-3"> 
          ...
          <a class="btn btn-primary" href="/fax/ajouter">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Table des Faxs</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <tbody>
                ...
                <tr>
                   <td hidden="hidden">{{$fax->id}}</td>
                  <td>{{'+213 '.$fax->fax}}</td>
                   <td>
                    <p>
                       <a  data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/fax/modifier/{{$fax->id}}">
                        <i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span>
          </a></p></td>
                        <td>
                          <p >
                          <a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();"  href="/fax/supprimer/{{$fax->id}}"class="btn btn-danger btn-xs">
 ...
 function sure()
{
    return(confirm('Etes-vous sûr de vouloir supprimer ce Fax ?'));
}
</script>
