...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/contact/adresse"><i class="fa fa-angle-right"></i> Adresses</a></li>
    ...
    <section class="content-header">
         ...
         <div class="row">
		 <div class="col-md-3">
          <a class="btn btn-primary" href="/adresse/ajouter">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Nos Adresses</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Table des Adresses</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                   <td hidden="hidden">{{$adresse->id}}</td>
                  <td>{{$adresse->adresse}}</td>
                   <td><p >
                       <a data-placement="top" data-toggle="tooltip" title="Editer" class="btn btn-warning btn-xs" href="/adresse/modifier/{{$adresse->id}}"><i class="fa fa-pencil"></i>
            <span class="nav-link-text"></span></a></p></td>
                        <td><p ><a data-placement="top" data-toggle="tooltip"  title="Supprimer" onclick="return sure();" href="/adresse/supprimer/{{$adresse->id}}"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
            <span class="nav-link-text"></span></a></p></td>
 ...
 function sure()
{
    return(confirm('Etes-vous sûr de vouloir supprimer cette Adresse ?'));
}
</script>
